...
import { SplitComponent as AngularSplitComponent, SplitAreaDirective } from 'angular-split';

// IMplementation of amgular split
// https://bertrandg.github.io/angular-split/#/examples/simple-split
@Component({
